...
CREATE TABLE IF NOT EXISTS `%%PREFIX%%Shop_Merchandise` (
    ...
    `PrivateSubject` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Private content title, which should be exists if you want to sending email be a part of the important steps',
    `PrivateMessage` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Private message content',
